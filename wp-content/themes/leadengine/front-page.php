 ...
 */
 ...
 ?>
<?php putRevSlider('finance-slider', 'homepage'); ?>
<?php if( is_home() ) : ?>
...
<h3 class="text-center">SENASTE INLÄGGEN</h3>
...
<div class="col-sm-4" style="margin-top:15px;">
  ...
  <p class="light-grey"><?php echo substr(strip_tags($post->post_content), 0, 150);?>...</p>
